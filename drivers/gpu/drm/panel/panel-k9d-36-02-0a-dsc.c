...
static const struct regulator_bulk_data k9d_36_02_0a_dsc_supplies[] = {
	{ .supply = "vdd" },
	{ .supply = "vddio" },
	{ .supply = "dvdd" },
};

static inline struct k9d_36_02_0a_dsc *
to_k9d_36_02_0a_dsc(struct drm_panel *panel)
{
...
static int k9d_36_02_0a_dsc_on(struct k9d_36_02_0a_dsc *ctx)
{
	...
	mipi_dsi_dcs_write_seq(dsi, 0xba, 0x01, 0xe6, 0x00, 0x10, 0x00, 0x30,
			       0x00, 0x01);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xc1, 0x30, 0x0f, 0x04, 0xc9, 0x0f, 0x81,
			       0xee, 0xc6, 0x3f, 0xfb, 0xb3, 0x6a, 0x3f, 0xf6,
			       0xd1, 0x42, 0x80, 0x00, 0xf7, 0x33, 0xb1, 0x00,
			       0x18, 0x00, 0x00, 0x8b, 0x23, 0x33, 0xc0, 0x0f,
			       0xb9, 0x0f, 0xdd, 0x8d, 0x00, 0x00, 0x00, 0x0d,
			       0x08, 0x00, 0x17, 0x23, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc2, 0x38, 0x0f, 0x0b, 0x64, 0x02, 0x11,
			       0xf6, 0x4c, 0x3f, 0xfa, 0xe2, 0x14, 0xff, 0xfe,
			       0x41, 0xa8, 0x00, 0x00, 0x5e, 0x26, 0x90, 0x00,
			       0x00, 0x24, 0x00, 0x17, 0x90, 0x33, 0xc0, 0x09,
			       0xb4, 0x0f, 0x94, 0xe9, 0x00, 0x00, 0x90, 0x0d,
			       0x3c, 0x90, 0x17, 0x57, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x3c, 0x00, 0x04, 0xc9, 0x0f, 0x81,
			       0x11, 0x3a, 0x3f, 0xf9, 0x58, 0x7c, 0x00, 0x04,
			       0xf1, 0x78, 0x00, 0x00, 0x00, 0x00, 0x00, 0x90,
			       0x18, 0x3c, 0x90, 0x8b, 0x5f, 0x33, 0x60, 0x00,
			       0x00, 0x0c, 0xdd, 0x73, 0x00, 0x00, 0x04, 0x20,
			       0x08, 0x04, 0x2a, 0x23, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc4, 0x3c, 0x00, 0x0b, 0x64, 0x02, 0x11,
			       0x09, 0xb4, 0x3f, 0xf6, 0xca, 0x24, 0xc0, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80,
			       0x00, 0xcf, 0x90, 0x17, 0x3b, 0x33, 0xc0, 0x00,
			       0x00, 0x0c, 0x94, 0x17, 0x00, 0x00, 0x94, 0x20,
			       0x3c, 0x94, 0x2a, 0x57, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc5, 0x26, 0x00, 0x04, 0xc9, 0x0f, 0x81,
			       0x11, 0x3a, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xef,
			       0x14, 0x34, 0x80, 0x00, 0x00, 0x00, 0x00, 0x03,
			       0xac, 0x00, 0x04, 0x1f, 0x23, 0x33, 0xc0, 0x00,
			       0x00, 0x03, 0x23, 0x8d, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc6, 0x2e, 0x00, 0x0b, 0x64, 0x02, 0x11,
			       0x09, 0xb4, 0x00, 0x03, 0x11, 0xf4, 0xff, 0xfd,
			       0x62, 0x7c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04,
			       0x20, 0x24, 0x04, 0x37, 0x90, 0x33, 0xc0, 0x00,
			       0x00, 0x03, 0x6c, 0xe9, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc7, 0x2a, 0x0f, 0x04, 0xc9, 0x0f, 0x81,
			       0xee, 0xc6, 0x00, 0x02, 0x5a, 0xee, 0x00, 0x0c,
			       0xae, 0x86, 0x7f, 0xfd, 0xf9, 0xf3, 0x65, 0x93,
			       0xac, 0x3c, 0x94, 0x1f, 0x5f, 0x33, 0x6f, 0xf0,
			       0x47, 0x00, 0x23, 0x73, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc8, 0x2a, 0x0f, 0x0b, 0x64, 0x02, 0x11,
			       0xf6, 0x4c, 0x00, 0x07, 0x29, 0xe4, 0xc0, 0x00,
			       0xdf, 0x2c, 0x7f, 0xff, 0x43, 0xb2, 0xe0, 0x84,
			       0x20, 0xcf, 0x94, 0x37, 0x3b, 0x33, 0xcf, 0xf6,
			       0x4c, 0x00, 0x6c, 0x17, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xc9, 0x27, 0x00, 0x03, 0xc1, 0x04, 0x41,
			       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xfe,
			       0xf8, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x63, 0x24, 0x00, 0x84, 0x43, 0x33, 0x90, 0x00,
			       0x00, 0x03, 0x1f, 0xdf, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xca, 0x21, 0x00, 0x03, 0xc1, 0x04, 0x00,
			       0x00, 0x00, 0x3f, 0xff, 0x0f, 0xc0, 0x3f, 0xff,
			       0x08, 0x00, 0x00, 0x00, 0x0f, 0x04, 0x00, 0x00,
			       0x42, 0x24, 0x00, 0x62, 0x43, 0x33, 0x90, 0x03,
			       0xe0, 0x0f, 0xe1, 0xe0, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xcb, 0x2d, 0x00, 0x04, 0x00, 0x04, 0x00,
			       0x00, 0x00, 0x3f, 0xff, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x42, 0x44, 0x00, 0x62, 0x64, 0x33, 0x60, 0x00,
			       0x00, 0x0c, 0xe0, 0x20, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xcc, 0x2b, 0x00, 0x04, 0x00, 0x04, 0x41,
			       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0xff, 0xff, 0xee, 0xfc, 0x00, 0x00,
			       0x63, 0x44, 0x00, 0x84, 0x64, 0x33, 0x6f, 0xfb,
			       0xe0, 0x00, 0x20, 0x21, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00);
	...
	mipi_dsi_dcs_write_seq(dsi, 0x91, 0xab, 0x28, 0x00, 0x0c, 0xc2, 0x00,
	...
	mipi_dsi_dcs_write_seq(dsi, 0x6f, 0x02);
	mipi_dsi_dcs_write_seq(dsi, 0xec, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			       0x00, 0x00, 0x00, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xf0, 0x55, 0xaa, 0x52, 0x08, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0x6f, 0x08);
	...
	mipi_dsi_dcs_write_seq(dsi, 0xce, 0x00);
	mipi_dsi_dcs_write_seq(dsi, 0xf0, 0x55, 0xaa, 0x52, 0x08, 0x01);
	mipi_dsi_dcs_write_seq(dsi, 0xc3, 0x94, 0x01, 0x97, 0xd0, 0x22, 0x02,
			       0x00);
...
static int k9d_36_02_0a_dsc_prepare(struct drm_panel *panel)
{
	...
	ret = regulator_bulk_enable(ARRAY_SIZE(k9d_36_02_0a_dsc_supplies),
				    ctx->supplies);
	if (ret < 0) {
	...
	if (ret < 0) {
		...
		gpiod_set_value_cansleep(ctx->reset_gpio, 1);
		regulator_bulk_disable(ARRAY_SIZE(k9d_36_02_0a_dsc_supplies),
				       ctx->supplies);
		return ret;
	}
...
static const struct drm_display_mode k9d_36_02_0a_dsc_modes[] = {
	{ /* 90Hz mode */
		.clock = (1080 + 16 + 8 + 8) * (2400 + 1212 + 4 + 8) * 90 / 1000,
		.hdisplay = 1080,
		.hsync_start = 1080 + 16,
		.hsync_end = 1080 + 16 + 8,
		.htotal = 1080 + 16 + 8 + 8,
				      ...
				      struct drm_connector *connector)
{
	...
	for (int i = 0; i < ARRAY_SIZE(k9d_36_02_0a_dsc_modes); i++) {
		count += drm_connector_helper_get_modes_fixed(connector,
						    &k9d_36_02_0a_dsc_modes[i]);
	}
...
static int k9d_36_02_0a_dsc_probe(struct mipi_dsi_device *dsi)
{
	...
	ret = devm_regulator_bulk_get_const(
		dev, ARRAY_SIZE(k9d_36_02_0a_dsc_supplies),
		k9d_36_02_0a_dsc_supplies, &ctx->supplies);
	if (ret < 0)
